...
As a user, I want to see a list/menu of all available kegs. For each keg, I want to see its name, brand, price and alcoholContent (or perhaps something like flavor for a kombucha store).<br>
As a user, I want to submit a form to add a new keg to a list.<br>
As a user, I want to be able to click on a keg to see its detail page.<br>
As a user, I want to see how many pints are left in a keg.<br>
